...
public final class ActivityProductListBinding implements ViewBinding {
  ...
  private ActivityProductListBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView recyclerProductList) {
  ...
  public static ActivityProductListBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.recyclerProductList;
      RecyclerView recyclerProductList = rootView.findViewById(id);
      if (recyclerProductList == null) {
        break missingId;
      }

      return new ActivityProductListBinding((ConstraintLayout) rootView, recyclerProductList);
    }
